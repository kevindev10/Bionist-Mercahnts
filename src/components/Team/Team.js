  ...
  return (
    <div className="">
    		...
    		<div className ='spacer '></div>
			 ...
			 <h3 className='div-background-images slider-image-size-on-mobile 'style={{"backgroundImage": "url(" + banner + ") ", "object-fit":"100%" , 'height':'350px'}}>
                    ...
                    <div className='flex white f4 mh2  pv4 ph5 fw1 tc tracked-l '>
                    	...
                    	<p>/</p>
                    	<p>
                    	<Link to='/team' className='ph2 white pointer no-underline dim'>Team</Link>
                    	</p>
                    </div>
    	...
    	<div className='pv4 ' style={{'background-color':'#F5F4F4'}}> 
   		<h1 className='tc about-heading-on-mobile' style={{'font-family': 'Audiowide', }}>Highly Talented & Reliable Team</h1>
   		<p className='tc about-paragraph-on-mobile'>We have a team of experts to work with you through the sale, installation and after sale services.
		</p>
		</div>



		<div className='pv5 mv5' style={{'height':'200px'}}>
		</div>
